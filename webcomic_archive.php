	...
	<section id="content">
		<div>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<?php
					$format     = ( 'month' == $post_meta[ 'webcomic_group' ] ) ? 'grid' : 'grid';
					...
					webcomic_archive( 'limit=10&order=DESC&last_only=1&group=' . $post_meta[ 'webcomic_group' ] . '&format=' . $format . $image . $collection );
